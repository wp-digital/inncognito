...
final class Plugin {
	...
	public function __construct(
		...
		if ( ! preg_match( '/^https?:\/\//i', $domain ) ) {
			$domain = sprintf( self::DOMAIN_MASK, $domain, $region );
		}
		...
		$this->integrations[ self::INTEGRATION_GOOGLE_AUTHENTICATOR ] = new Integrations\GoogleAuthenticator\Integration();
		$this->integrations[ self::INTEGRATION_POLYLANG ]             = new Integrations\Polylang\Integration();
	}
	...
	public function show_profile( WP_User $user ) : void {
		...
		require_once __DIR__ . '/../public/views/profile.php';
	}
